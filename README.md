...
**объектная модель, коллекции, система ввода-вывода, работа с файлами, сериализация, работа с XML, JSON, SQL, персистентность в базу данных (PostgreSQL), сервлеты, HTML/JSP/JSTL, веб-контейнер Tomcat, модульные тесты JUnit, java.kz.akbar.basejava.util.Logging, система контроля версий Git.**
...
### Занятие 12
 - [java.kz.akbar.basejava.util.concurrent](lesson/lesson12.md#javautilconcurrent)
